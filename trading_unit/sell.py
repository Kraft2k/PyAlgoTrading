...
class LimitCancel(bt.Strategy):
    ...
    def next(self):
        ...
        self.order = self.close()  # Лимитная заявка на покупку
...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    data = store.getdata(dataname=symbol_svcb, timeframe=bt.TimeFrame.Minutes, compression=5,
    ...
    #cerebro_chmf.adddata(data_chmf)
